...
LV_IMG_DECLARE( ui_img_blaster_png);   // assets/blaster.png
LV_IMG_DECLARE( ui_img_dlt19x_png);   // assets/dlt19x.png
LV_IMG_DECLARE( ui_img_lightsaber_png);   // assets/lightsaber.png
